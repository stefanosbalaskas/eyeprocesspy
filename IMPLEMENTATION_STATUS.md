...
|---|---:|
| P0 discovered | 1182 |
| P1 API implemented | 512 |
| P2 structural initial | 512 |
| P3 semantic initial | 512 |
| P4 cross-language numerical tested | 56 initial only; extended R oracle pending |
| P5 source-ported algorithms/gates | 457 |
| P5 Python reference/backend-different algorithms | 55 |
| Public Python `plot_*` callables currently present | 116 |
| Plot-ledger rows explicitly verified `implemented` | 54 / 341 |
| Python article counterparts complete | 43 / 88 |
| Executable `irt_*.py` examples | 29 |
