...
- Full local pytest suite: **197/197 passed in deterministic split batches**.
...
- Executable `irt_*.py` example smoke suite: **42 passed**.
- Frozen exports with implemented Python callables: **715/1,182**.
- Plot-ledger rows explicitly verified as implemented: **158/341**.
- Python article counterparts marked complete: **55/88**.
