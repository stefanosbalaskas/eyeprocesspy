...
d = pd.DataFrame(
    {
        ...
        "dwell": rng.normal(700, 70, n),
        "entropy": rng.random(n),
        "pupil": rng.normal(size=n),
        "validity": rng.uniform(0.8, 1, n),
        "criterion": rng.normal(size=n),
    }
)
blocks = ep.process_feature_blocks(
    d,
    {
...
profiles = ep.fit_process_profile_mixture(
    d, ["dwell", "entropy", "pupil"], k=3, engine="kmeans_reference"
)
