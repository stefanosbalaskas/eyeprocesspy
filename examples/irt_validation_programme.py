...
assert summary.rmse.iloc[0] < 0.1
...
negative = ep.negative_control_process_test(
    data, "process", lambda d: float(d.y.corr(d.process)), within="person", permutations=20, seed=5
)
